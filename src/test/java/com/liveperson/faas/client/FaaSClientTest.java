...
public class FaaSClientTest {
     ...
     * "]";
     * Map<String, String> headers = getTestHeaders();
     * FaaSInvocation<UUIDResponse> invocationData =
     * getUUIDResponseFaaSInvocation(payload, timestamp,
     * headers);
     * EventResponse expectedResponse = getExpectedResponse();
     * 
     * when(restClientMock.post(eq(getExpectedInvokeEventUrl()),
     * httpHeaderCaptor.capture(),
     ...
     * 
     * verify(metricCollectorMock,
     * times(1)).onInvokeByEventSuccess(eq(externalSystem), anyInt(),
     * eq(event.toString()),
     * eq(accountId));
     * assertEquals("Lambda invocation with the wrong body",
     * getExpectedRequestBody(timestamp,
     ...
     * eq(event.toString()),
     * eq(accountId));
     * verify(authDPoPSignatureBuilder,
     * times(1)).getAccessTokenInternal(eq("https://" + faasGWUrl));
     * verify(authDPoPSignatureBuilder, times(1)).getDpopHeaderInternal(
     ...
     * httpBodyCaptor.getValue());
     * assertTrue("Lambda invocation with wrong authorization header",
     * httpHeaderCaptor.getValue().get("Authorization").equals("DPoP " +
     * accessToken));
     * assertTrue("Lambda invocation with wrong DPoP header",
     * httpHeaderCaptor.getValue().get("DPoP").equals(dpopHeader));
     * assertEquals("Lambda invocation result does not match expected value",
     ...
     * 
     * verify(metricCollectorMock,
     * times(1)).onInvokeByEventSuccess(eq(externalSystem), anyFloat(),
     ...
     * 
     * @Test(expected = FaaSException.class)
     * public void invokeViaEventTypeThrowFaaSException() throws IOException,
     * FaaSException {
     * try {
     * long timestamp = System.currentTimeMillis();
     * FaaSInvocation<String> invocationData = new FaaSInvocation<String>(null,
     * null);
     * invocationData.setTimestamp(timestamp);
     * 
     * when(restClientMock.post(eq(getExpectedInvokeEventUrl()),
     ...
     * client.invokeByEvent(externalSystem, event, invocationData,
     * EventResponse[].class,
     * optionalParams);
     * } catch (Exception ex) {
     * verify(metricCollectorMock,
     * times(1)).onInvokeByEventFailure(eq(externalSystem), anyFloat(),
     ...
     * 
     * @Test(expected = FaaSLambdaException.class)
     * public void invokeViaEventTypeThrowsFaaSLambdaException() throws IOException,
     * FaaSException {
     * try {
     * long timestamp = System.currentTimeMillis();
     * FaaSInvocation<String> invocationData = new FaaSInvocation<String>(null,
     * null);
     * invocationData.setTimestamp(timestamp);
     * FaaSError faaSError = new
     * FaaSError(FaaSLambdaErrorCodesV1.CUSTOM_FAILURE.getCode(),
     * "My custom error.");
     * 
     * when(restClientMock.post(eq(getExpectedInvokeEventUrl()),
     * httpHeaderCaptor.capture(),
     ...
     * 
     * client.invokeByUUID(externalSystem, lambdaUUID, faaSInvocation,
     * optionalParams);
     * 
     * verify(metricCollectorMock,
     * times(1)).onInvokeByUUIDSuccess(eq(externalSystem), anyFloat(),
     * eq(lambdaUUID),
     * eq(accountId));
     ...
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * 
     * clientWithDPoP.invokeByUUID(externalSystem, lambdaUUID, faaSInvocation,
     * optionalParams);
     * 
     * verify(metricCollectorMock,
     * times(1)).onInvokeByUUIDSuccess(eq(externalSystem), anyFloat(),
     ...
     * verify(restClientMock, times(1)).post(getExpectedInvokeUUIDUrl(),
     * expectedHeaders,
     * faaSInvocation.toString(), optionalParams.getTimeOutInMs());
     * }
     * 
     * @Test
     * public void invokeWithUUIDWithRequestIdWithoutResponse() throws IOException,
     * FaaSException {
     ...
     * 
     * @Test
     * public void invokeWithFaaSEventWithoutResponse() throws IOException,
     * FaaSException {
     * Map<String, String> headers = getHeaders();
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * 
     ...
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * 
     * clientWithDPoP.invokeByEvent(externalSystem, event, faaSInvocation,
     * optionalParams);
     * 
     * verify(authDPoPSignatureBuilder,
     * times(1)).getAccessTokenInternal(eq("https://" + faasGWUrl));
     ...
     * expectedHeaders.put("Authorization", "DPoP " + accessToken);
     * expectedHeaders.put("DPoP", dpopHeader);
     * verify(restClientMock, times(1)).post(getExpectedInvokeEventUrl(),
     * expectedHeaders,
     * faaSInvocation.toString(), optionalParams.getTimeOutInMs());
     * }
     * 
     * @Test
     * public void invokeWithFaaSEventWithEventStringWithoutResponse() throws
     * IOException, FaaSException {
     * Map<String, String> headers = getHeaders();
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * 
     * client.invokeByEvent(externalSystem, event.toString(), faaSInvocation,
     * optionalParams);
     * 
     * verify(metricCollectorMock,
     * times(1)).onInvokeByEventSuccess(eq(externalSystem), anyFloat(),
     ...
     * 
     * @Test
     * public void invokeWithFaaSEventWithRequestIdWithoutResponse() throws
     * IOException, FaaSException {
     * Map<String, String> headers = getCompleteHeaders();
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * optionalParams.setRequestId(requestId);
     ...
     * 
     * @Test
     * public void invokeWithFaaSEventWithRequestIdAndEventStringWithoutResponse()
     * throws IOException, FaaSException {
     * Map<String, String> headers = getCompleteHeaders();
     * FaaSInvocation<String> faaSInvocation = getStringFaaSInvocation(headers);
     * optionalParams.setRequestId(requestId);
     * 
     ...
     * 
     * @Test(expected = FaaSDetailedException.class)
     * public void invokeViaUUIDNoResponseThrowsFaasDetailedException() throws
     * Exception {
     * long timestamp = System.currentTimeMillis();
     * FaaSInvocation<String> invocationData = new FaaSInvocation<String>(null,
     * null);
     ...
     * FaaSError faaSError = new FaaSError("faas.error.code", "My custom error.");
     * 
     * when(restClientMock.post(eq(getExpectedInvokeUUIDUrl()),
     * httpHeaderCaptor.capture(),
     * httpBodyCaptor.capture(), eq(defaultTimeOut)))
     * .thenThrow(new RestException("Error during rest call.",
     * objectMapper.writeValueAsString(faaSError),
     * 500));
     * client.invokeByUUID(externalSystem, lambdaUUID, invocationData,
     * optionalParams);
     * }
     * 
     * @Test(expected = FaaSLambdaException.class)
     * public void invokeViaUUIDNoResponseThrowFaaSLambdaException() throws
     * Exception {
     * long timestamp = System.currentTimeMillis();
     * FaaSInvocation<String> invocationData = new FaaSInvocation<String>(null,
     * null);
     ...
     * 
     * @Test(expected = FaaSException.class)
     * public void invokeViaUUIDNoResponseThrowsFaaSException() throws IOException,
     * FaaSException {
     * try {
     * long timestamp = System.currentTimeMillis();
     * FaaSInvocation<String> invocationData = new FaaSInvocation<String>(null,
     ...
     * } catch (Exception ex) {
     * verify(metricCollectorMock,
     * times(1)).onInvokeByUUIDFailure(eq(externalSystem), anyFloat(),
     * eq(lambdaUUID),
     * eq(accountId), eq(-1), any());
     * throw ex;
     * }
     ...
     * 
     * when(restClientMock.get(eq(getExpectedLambdasOfAnAccountUrl()),
     * httpHeaderCaptor.capture(),
     * eq(defaultTimeOut)))
     * .thenReturn(mockResponse);
     * List<LambdaResponse> actualResponse = client.getLambdas(userId, new
     ...
     * });
     * 
     * verify(metricCollectorMock, times(1)).onGetLambdasSuccess(eq(userId),
     * anyFloat(), eq(accountId));
     ...
     * eq(defaultTimeOut)))
     * .thenReturn(mockResponse);
     * List<LambdaResponse> actualResponse = clientWithDPoP.getLambdas(userId, new
     * HashMap<String, String>(),
     * optionalParams);
     * List<LambdaResponse> expectedResponse = objectMapper.readValue(mockResponse,
     * new TypeReference<List<LambdaResponse>>() {
     ...
     * anyFloat(), eq(accountId));
     * verify(authDPoPSignatureBuilder,
     * times(1)).getAccessTokenInternal(eq("https://" + faasUIUrl));
     * verify(authDPoPSignatureBuilder, times(1)).getDpopHeaderInternal(
     ...
     * String expectedUrl =
     * String.format("https://faasUI.com/api/account/%s/lambdas?v=1&userId=%s" +
     * "&state=Productive&eventId=eventId&name=myFilter", accountId, userId);
     * 
     * when(restClientMock.get(urlCaptor.capture(), any(),
     * anyInt())).thenReturn(myResponse);
     * try {
     ...
     * FaaSError faaSError = new FaaSError("faas.error.code", "My custom error.");
     * 
     * when(restClientMock.get(eq(getExpectedLambdasOfAnAccountUrl()), anyMap(),
     * eq(defaultTimeOut)))
     ...
     * } catch (Exception ex) {
     * verify(metricCollectorMock, times(1)).onGetLambdasFailure(eq(userId),
     * anyFloat(), eq(accountId),
     * eq(500),
     * any());
     * throw ex;
     ...
     * 
     * @Test(expected = FaaSException.class)
     * public void getLambdasThrowFaaSExceptionIfResponseNotParsable() throws
     * IOException, FaaSException {
     * try {
     * when(restClientMock.get(eq(getExpectedLambdasOfAnAccountUrl()),
     * httpHeaderCaptor.capture(),
     ...
     * 
     * @Test(expected = FaaSException.class)
     * public void getLambdasThrowFaaSExceptionWhenRuntimeExceptionOccurs() throws
     * IOException, FaaSException {
     * try {
     * when(restClientMock.get(eq(getExpectedLambdasOfAnAccountUrl()),
     * httpHeaderCaptor.capture(),
     ...
     * 
     * when(restClientMock.get(eq(getExpectedIsImplementedUrl()),
     * httpHeaderCaptor.capture(),
     * eq(defaultTimeOut))).thenReturn(
     * "{\"implemented\": true}");
     * when(defaultIsImplementedCacheMock.getIfCachedAndValid(eq(event.toString())))
     ...
     * 
     * verify(metricCollectorMock,
     * times(0)).onIsImplementedSuccess(eq(externalSystem), anyFloat(),
     * eq(event.toString()), eq(accountId));
     ...
     * .thenReturn(null);
     * 
     * boolean isImplemented = clientWithDPoP.isImplemented(externalSystem, event,
     * optionalParams);
     * 
     * assertTrue("Lambda should be implemented", isImplemented);
     * // verify(restClientMock, times(0)).get(any(), any(),
     ...
     * 
     * @Test(expected = FaaSDetailedException.class)
     * public void isImplementedThrowsFaaSDetailedException() throws IOException,
     * FaaSException {
     * try {
     * FaaSError faaSError = new FaaSError("faas.error.code", "My custom error.");
     * 
     ...
     * } catch (Exception ex) {
     * verify(metricCollectorMock,
     * times(1)).onIsImplementedFailure(eq(externalSystem), anyFloat(),
     * eq(event.toString()), eq(accountId), eq(500), any());
     * throw ex;
     * }
     * }
     * 
     * @Test(expected = FaaSException.class)
     * public void isImplementedThrowFaaSException() throws FaaSException,
